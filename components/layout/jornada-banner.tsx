...
export default async function JornadaBanner() {
    ...
    return (
        <div className="bg-emerald-50 border-b border-emerald-200 px-6 py-2 flex items-center justify-between text-sm">
            <div className="flex items-center gap-4 text-emerald-900">
                <span className="font-medium">Jornada #{data.jornada.id}</span>
                <span>
                    Esperado en caja: <strong>${expectedCash.toFixed(2)}</strong>
                </span>
                <span className="text-emerald-700/70 hidden md:inline">
